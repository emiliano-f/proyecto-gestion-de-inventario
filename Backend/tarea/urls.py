...
urlpatterns = [
    ...
    path('tareas/<int:pk>/orden-servicio/', views.TareaCRUD.as_view({'get':'retrieve_orden_servicio'}), name='tarea-orden'),
    path('sector/subsectores/<str:nombre>/', views.SectorListCRUD.as_view({'get':'retrieve'}), name='sectores-list-id'), 
]
